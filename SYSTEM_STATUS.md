...
- **Môi trường chạy:** macOS (Apple Silicon), lưu trữ trực tiếp trên thư mục mount Nextcloud (`/Users/khan/Developer/Long2Short`).
...
- **Vị trí:** [render_long2short.command](file:///Users/khan/Developer/Long2Short/render_long2short.command)
...
- **Vị trí:** [render.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/render.js) (hàm `renderScene` và `renderTemporalWarpScene`).
- **Logic hoạt động:**
...
- **Vị trí:** [render.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/render.js) (hàm `resolveVoiceWav` + `renderScene`).
...
- **Vị trí:** [render.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/render.js) (hàm `cleanupTempDir`).
...
| :--- | :---: | :--- | :--- |
| [render.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/render.js) | ~44KB | **Cốt lõi.** Điều phối toàn bộ quy trình render: đọc timeline JSON, dựng lệnh ffmpeg, ghép cảnh (`concat`), quản lý hàng đợi `incoming/` | `renderScene`, `renderTemporalWarpScene`, `hasAudioStream` (chèn `anullsrc`), `cleanupTempDir`, `archiveSuccessfulRender`, `handleProjectFailure` |
| [effects.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/effects.js) | ~28KB | Registry toàn bộ hiệu ứng hình ảnh: zoom, shake, speed ramp, cinematic... Chứa hàm xây dựng tham số filter ffmpeg cho từng effect | `normalizeAdvancedEffect`, `buildEffectArgs`, `ADVANCED_EFFECT_ENUMS` — load động từ `config/effectEnums.json` |
| [effectLearning.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/effectLearning.js) | ~10KB | **Học máy hiệu ứng.** Ánh xạ tên hiệu ứng tùy ý từ AI sang tên hiệu ứng hợp lệ trong registry. Lưu vào `effects/learned_effects.json` | `resolveLearnedAdvancedEffect`, `initializeEffectLearning`, `learnFrequentFallbacksFromLogs`, `matchHeuristic`, `matchSimilarity` |
| [syncPromptEnums.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/syncPromptEnums.js) | ~1KB | Đồng bộ danh sách enum từ `config/effectEnums.json` vào `prompts/timeline_generator_prompt.md`. Chạy: `npm run sync-prompt` | Inject section `ENUM_VALID_VALUES` vào cuối prompt để AI biết các giá trị hợp lệ |
| [subtitleStyles.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/subtitleStyles.js) | ~10KB | Registry toàn bộ kiểu phụ đề: font, màu sắc, border, shadow, vị trí. Tương ứng với các `subtitle_style` trong prompt | `resolveSubtitleStyle`, `normalizeStyleKey` — ánh xạ `hook_bold`, `neon_glow`, `framed_card`, `gold_caption`, `cta_red` |
| [subtitleLayoutEngine.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/subtitleLayoutEngine.js) | ~3.6KB | Tính toán bố cục an toàn (safe zone) để phụ đề không che sản phẩm, tự wrap chữ nếu quá dài | `prepareSubtitleLayout` — tính `safeX`, `safeBottom`, `baseFontSize` theo độ phân giải thực tế |
| [textPositionEngine.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/textPositionEngine.js) | ~0.7KB | Chuẩn hóa giá trị `text_position` đầu vào (`top`, `center`, `bottom`). Fallback về `bottom` nếu giá trị không hợp lệ | `normalizePosition` |
| [fontRegistry.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/fontRegistry.js) | ~3.4KB | Quét và đăng ký font chữ từ hệ thống macOS + thư mục `assets/fonts/`. Tạo `FONTCONFIG_PATH` trỏ vào `temp/fontconfig` | `initFontRegistry`, `resolveFont` — dùng để ffmpeg tìm font khi vẽ chữ lên video |
| [captionGenerator.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/captionGenerator.js) | ~0.7KB | Sinh nội dung caption/post text từ `video_meta` của timeline JSON để dùng cho mạng xã hội | `buildPostText` — đọc `title`, `description`, `hashtags` từ `video_meta` |
| [archiveWorkflow.js](file:///Users/khan/Developer/Long2Short/renderer/scripts/archiveWorkflow.js) | ~2.3KB | Quản lý vòng đời project sau khi render xong: di chuyển video thành phẩm sang `rendered/` hoặc `failed/`, tạo folder archive có timestamp | `createWorkflowContext`, `archiveSuccessfulRender`, `handleProjectFailure` |

**Config file:**
| [effectEnums.json](file:///Users/khan/Developer/Long2Short/renderer/config/effectEnums.json) | ~0.5KB | **Single Source of Truth** cho toàn bộ enum của `advanced_effect` | Được `effects.js` load động và `syncPromptEnums.js` dùng để inject vào prompt |
...
| :--- | :--- | :--- |
| [timeline_generator_prompt.md](file:///Users/khan/Developer/Long2Short/renderer/prompts/timeline_generator_prompt.md) | Nhận diện/Cắt cảnh, gán hiệu ứng chữ & chuyển cảnh tạo JSON Timeline | [timeline_generator_prompt.v1.md](file:///Users/khan/Developer/Long2Short/renderer/prompts/backups/timeline_generator_prompt.v1.md) |
| [video_style_learning_prompt.md](file:///Users/khan/Developer/Long2Short/renderer/prompts/video_style_learning_prompt.md) | Phân tích phong cách dựng từ video mẫu | [video_style_learning_prompt.v1.md](file:///Users/khan/Developer/Long2Short/renderer/prompts/backups/video_style_learning_prompt.v1.md) |
| [render_analyzer_prompt.md](file:///Users/khan/Developer/Long2Short/renderer/prompts/render_analyzer_prompt.md) | QA/Rà soát và tối ưu hóa JSON Timeline trước khi render | [render_analyzer_prompt.v1.md](file:///Users/khan/Developer/Long2Short/renderer/prompts/backups/render_analyzer_prompt.v1.md) |
